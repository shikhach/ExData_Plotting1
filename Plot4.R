...
plot(dt, as.numeric(df$Global_active_power), type="l", xlab="", ylab="Global Active Power")
plot(dt, as.numeric(df$Voltage), type="l", xlab="datetime", ylab="Voltage")
...
plot(dt, as.numeric(df$Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power")
